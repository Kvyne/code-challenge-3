...
$(document).ready(function() {
    ...
    function displayMovieDetails(movie) {
      ...
      $("#ticket-num").text(movie.capacity - movie.tickets_sold);
    ...
    $(".film.item").click(function() {
      ...
      var selectedMovieId = $(this).attr("id");
      var selectedMovie = filmsData.find(movie => movie.id === selectedMovieId);
      if (selectedMovie) {
    ...
    $("#buy-ticket").click(function() {
      var selectedMovieId = $(".film.item.active").attr("id");
      var selectedMovie = filmsData.find(movie => movie.id === selectedMovieId);
      if (selectedMovie) {
        if (selectedMovie.tickets_sold < selectedMovie.capacity) {
          selectedMovie.tickets_sold++;
          $("#ticket-num").text(selectedMovie.capacity - selectedMovie.tickets_sold);
          if (selectedMovie.tickets_sold === selectedMovie.capacity) {
            $("#" + selectedMovieId).addClass("sold-out");
          }
    ...
    // Initialize movie details for the first movie
    displayMovieDetails(filmsData[0]);
